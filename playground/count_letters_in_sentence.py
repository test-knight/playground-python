...
# sentence = 'It is a beautiful day in Atlanta, weather is 80 when the clocks strikes 12 noon.'
sentence = '''
...
work, (b) altertion, modification, or additions or deletions to any
...
pprint.pprint(count)
count_text = pprint.pformat(count)
print(count_text)